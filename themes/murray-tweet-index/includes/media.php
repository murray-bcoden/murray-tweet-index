	...
	<div class="media-wrapper">
		...
		<div class="media-info-wrap">
			...
			<div class="media-type-wrapper">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/media-type.svg" alt="Media Type Infographic" class="media-type">
			</div>
			<div class="most-list-wrapper">
				...
				<ol class="most-list">
					...
					<li class="most-list-item">
						...
						<div class="graph-bar most-bar"><span></span></div>
