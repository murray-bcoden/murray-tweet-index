...
class WP_Hummingbird_GZIP_Page extends WP_Hummingbird_Admin_Page {
	...
	public function render_header() {
		...
		<?php if ( isset( $_GET['gzip-enabled'] ) ): ?>
			<div class="wphb-notice wphb-notice-success" id="wphb-notice-settings-updated">
				<p><?php _e( 'Gzip enabled. Your .htaccess file has been updated', 'wphb' ); ?></p>
			</div>
		<?php endif; ?>

		<?php if ( isset( $_GET['gzip-disabled'] ) ): ?>
			<div class="wphb-notice wphb-notice-error" id="wphb-notice-settings-updated">
				<p><?php _e( 'Gzip disabled. Your .htaccess file has been updated', 'wphb' ); ?></p>
			</div>
		<?php endif; ?>
