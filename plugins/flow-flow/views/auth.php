...
<div class="section-content" data-tab="auth-tab">
	<div class="section" id="auth-settings">
		...
		<p class="desc">Valid for all (public) twitter accounts. You need to authenticate one (and any) twitter account here. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-twitter/">Follow setup guide</a></p>
		...
		<p class="desc">Valid to pull any public FB page. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-facebook/">Follow manual setup guide</a></p>
		<dl class="section-settings">
		...
		<p class="desc">You can use your own token or get token authorizing our app. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-instagram/">Follow manual setup guide</a></p>
        <dl class="section-settings">
			<dt class="vert-aligned">Access Token</dt>
			<dd>
		...
		<p class="desc">Valid to pull any public Google+ and YouTube page feed. <a target="_blank" href="http://social-streams.com/doc/authenticate-google-youtube/">Follow setup guide</a></p>
		<dl class="section-settings">
		...
		<p class="desc">Valid to pull any public Foursquare location comments. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-foursquare/">Follow setup guide</a></p>
		<dl class="section-settings">
			<dt class="vert-aligned">Access Token</dt>
			<dd>
		...
		<p class="desc">Valid to pull company pages where you are added as admin. <a target="_blank" href="http://social-streams.com/doc/authenticate-with-linkedin/">Follow setup guide</a></p>
