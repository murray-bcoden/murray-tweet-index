...
<div class="section-content" data-tab="auth-tab">
	<div class="section" id="auth-settings">
		...
		<dl class="section-settings">
			<dt class="vert-aligned">Access Token</dt>
			<dd>
				<input class="clearcache" type="text" id="foursquare_access_token" name="flow_flow_options[foursquare_access_token]" placeholder="Copy and paste from Foursquare" value="<?php echo $options['foursquare_access_token']?>"/>
			</dd>
