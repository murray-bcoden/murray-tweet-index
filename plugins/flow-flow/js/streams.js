            ...
            <dt>Items order\
                ...
                <dd>\
                    ...
                    <label for="stream-%id%-date-order">Strictly by date</label><br><br>\
                        ...
                        <dd><input type="text" id="stream-%id%-posts" name="stream-%id%-posts" value="30" class="short clearcache"/> posts <span class="space"></span><input type="text" class="short clearcache" name="stream-%id%-days"/> days</dd>\
                        ...
                        <dd><input type="text"  name="stream-%id%-page-posts" value="15" class="short clearcache"/> posts</dd>\
                        ...
                        <dt class="multiline">Cache lifetime\
                            <p class="desc">Make it longer if feeds are rarely updated or shorter if you need frequent updates. Minimum value is 3 minutes</p></dt>\
                        <dd>\
                            <label for="stream-%id%-cache-lifetime"><input min="3" id="stream-%id%-cache-lifetime" class="short clearcache" type="text" name="stream-%id%-cache-lifetime" value="10"/> minutes</label>\
                        </dd>\
                                      ...
                                      <label for="%uid%-likes-type">Likes timeline</label><br><br>\
                                                  ...
                                                  <dd>\
                                                      ...
                                                      <p class="desc">\
                                                            ...
                                                            3. For photos by hashtag enter one word without #\
                                                      </p>\
                                                              </dd>\
                                                              <dt>Hide text</dt>\
                                                              <dd>\
